      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-3 max-lg:grid-cols-2 max-md:grid-cols-1 gap-8">
          <div className="difference-card flex items-center justify-start flex-col gap-[16px]">
            ...
            <h3 className="text-[18px] max-lg:text-[16px] max-sm:text-[20px] text-[#232061] font-bold text-center max-md:leading-[40px]">
              Precision You Can Count On
            </h3>
            <p className="text-base max-sm:text-[15px] text-[#232061] text-center leading-[30px]">
