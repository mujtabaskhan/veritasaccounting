      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="font-flex text-[#232061] text-xl mb-12 max-sm:text-sm max-sm:mb-6">
          ...
          <p>
            ...
            https://www.veritasaccounting.ca or engaging our services, you agree
        ...
        <div className="font-flex flex flex-col gap-12 max-sm:gap-6 text-[#232061] text-xl max-sm:text-sm">
          ...
          <div>
            ...
            <p>
              ...
              agreement. Late payments may incur interest or service suspension
          ...
          <div>
            ...
            <p>
              We respect your privacy and maintain strict confidentiality of all
              client information.
            </p>
            <div>
              Your data will not be shared with third parties except as required
              by law or with your written consent. Please refer to our{" "}
          ...
          <div>
            ...
            <p>
              While we take every effort to ensure accuracy and quality in our
              work, Veritas Accounting & Tax Consultants is not liable for any
          ...
          <div>
            ...
            <p>
              ...
              or services at our discretion, without prior notice, if we believe
