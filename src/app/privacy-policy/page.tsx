    ...
    <section className="bg-white pt-20 px-4 pb-[198px] max-xl:pb-40 max-lg:pt-16 max-lg:pb-28 max-md:pt-12 max-md:pb-20 max-sm:pt-10 max-sm:!pb-0">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="font-flex text-[#232061] text-xl mb-12 max-sm:text-sm max-sm:mb-6">
          ...
          <p>
            At Veritas Accounting & Tax Consultants (“we,” “our,” or “us”), your
            privacy is our top priority. We are committed to protecting your
            personal information and maintaining transparency about how we
            collect, use, and safeguard it. This policy outlines our practices
            in compliance with Canada’s Personal Information Protection and
        ...
        <div className="font-flex flex flex-col gap-12 max-sm:gap-6 text-[#232061] text-xl max-sm:text-sm">
          <div>
            ...
            <p>
              We collect personal and business information necessary to provide
              our accounting, tax, and advisory services. This may include:
            </p>
          ...
          <div>
            ...
            <p>
              Despite these measures, no electronic system is completely secure.
              However, we continuously work to maintain the highest possible
              level of protection.
            </p>
          </div>
